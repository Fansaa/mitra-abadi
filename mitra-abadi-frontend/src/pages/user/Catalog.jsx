      ...
      <main className="pt-28 pb-16 px-8 max-w-[1600px] mx-auto min-h-screen">
        ...
        <header className="mb-14 flex flex-col md:flex-row md:items-end justify-between gap-8">
          <div className="max-w-xl">
            <span className="text-[10px] uppercase tracking-[0.15em] text-[#e61e25] font-extrabold mb-3 block">Distributor Kain Berkualitas</span>
            <h1 className="text-5xl md:text-6xl font-extrabold text-stone-900 leading-none tracking-tight">Katalog Kain</h1>
            <p className="mt-5 text-stone-500 max-w-lg leading-relaxed text-sm">Koleksi pilihan bahan tekstil berkualitas — dari kain rajut industri hingga katun premium yang lembut dan nyaman.</p>
          </div>
          <div className="flex items-center gap-3">
            <label className="text-[10px] uppercase tracking-widest font-extrabold text-stone-400 whitespace-nowrap">
              Kategori
            </label>
            <div className="relative">
              <select
                ...
                className="appearance-none bg-white border border-stone-200 text-stone-700 text-[11px] font-bold uppercase tracking-wider rounded px-4 py-2.5 pr-8 focus:outline-none focus:border-[#e61e25] transition-colors cursor-pointer"
              >
              ...
              <svg
                className="pointer-events-none absolute right-2.5 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-stone-400"
        ...
        <div className="flex flex-col lg:flex-row gap-14">
          ...
          <aside className="w-full lg:w-60 flex-shrink-0 space-y-10">
            {/* Palette */}
            <section>
              <h3 className="text-[10px] uppercase tracking-[0.15em] font-extrabold text-stone-400 mb-5 border-b border-stone-200 pb-2">Palet Warna</h3>
            ...
            <section className="p-5 bg-stone-100 rounded-sm border-l-4 border-[#e61e25]">
              ...
              <p className="text-xs text-stone-500 leading-relaxed italic">"Semua produk tersedia dalam satuan roll. Stok dan harga dapat berubah sewaktu-waktu. Hubungi admin untuk pemesanan."</p>
            </section>
          </aside>
          ...
          <div className="flex-grow">
            ...
            {loading ? (
              ...
              <div className="flex flex-col items-center justify-center py-24 text-center">
                ...
                <button onClick={() => { setActiveCategory("All"); setSelectedColor(null); setSearchQuery(""); }} className="mt-4 text-[#e61e25] text-xs font-bold uppercase tracking-wider hover:underline">Hapus semua filter</button>
              </div>
            ) : (
              <>
                ...
                {!hasMore && filteredProducts.length > ITEMS_PER_PAGE && (
                  <p className="mt-12 text-center text-[10px] uppercase tracking-widest text-stone-300 font-bold">— Semua produk telah ditampilkan —</p>
                )}
              </>
            )}
          </div>
